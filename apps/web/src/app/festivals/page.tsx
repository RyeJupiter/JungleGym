    ...
    <div className="min-h-screen bg-jungle-900">
      ...
      <section className="pt-28 pb-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl font-black tracking-tight text-white mb-6 leading-none">
            A space to move.<br />
            <span className="text-jungle-400">A space to play.</span>
          </h1>
          <p className="text-xl text-jungle-300 max-w-2xl mx-auto leading-relaxed mb-10">
      ...
      {/* The space */}
      <section id="the-space" className="py-20 px-6 bg-jungle-800">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-semibold text-jungle-400 uppercase tracking-widest mb-3">What we set up</p>
            <h2 className="text-4xl font-black text-white mb-4">The JungleGym space.</h2>
            <p className="text-jungle-300 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div key={card.title} className="bg-jungle-700/60 border border-jungle-600 rounded-2xl p-7">
      ...
      {/* Men's work */}
      <section className="py-20 px-6 bg-jungle-900">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-xs font-semibold text-jungle-400 uppercase tracking-widest mb-3">By invitation</p>
              <h2 className="text-4xl font-black text-white mb-5">Men&apos;s work.</h2>
              <p className="text-jungle-300 text-lg leading-relaxed mb-5">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.label} className="flex items-center gap-4 bg-jungle-800/60 border border-jungle-700 rounded-xl px-5 py-4">
      ...
      <section className="py-20 px-6 bg-stone-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-jungle-900 mb-4">Open, grounded, alive.</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={card.title} className="bg-white border border-jungle-100 rounded-2xl p-7">
                <div className="text-4xl mb-4">{card.emoji}</div>
      ...
      {/* Monkey see CTA */}
      <section className="py-20 px-6 bg-jungle-800 text-center">
      ...
      <section id="partner" className="py-20 px-6 bg-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-black text-jungle-900 mb-4">Want this at your festival?</h2>
          <p className="text-jungle-600 text-lg leading-relaxed mb-8">
          ...
          <a
            ...
            className="bg-jungle-900 hover:bg-jungle-800 text-white font-bold px-10 py-4 rounded-xl text-lg inline-block transition-colors"
          >
