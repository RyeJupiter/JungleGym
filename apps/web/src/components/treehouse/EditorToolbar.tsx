      ...
      <div className="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              onClick={() => { setShowThemes(!showThemes); setShowTemplates(false); setShowBanner(false) }}
          ...
          <div className="relative">
            <button
              onClick={() => { setShowBanner(!showBanner); setShowThemes(false); setShowTemplates(false) }}
              className={`flex items-center gap-1.5 bg-stone-800 hover:bg-stone-700 text-stone-200 text-xs font-semibold px-3 py-2 rounded-lg border transition-colors ${
                config.banner ? 'border-jungle-500' : 'border-stone-600'
              }`}
            >
          ...
          <div className="relative">
            <button
              onClick={() => { setShowTemplates(!showTemplates); setShowThemes(false); setShowBanner(false) }}
