...
export function CreatorsPanel({ initialCreators }: { initialCreators: UserSearchResult[] }) {
    ...
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-sm font-semibold text-stone-400 uppercase tracking-wider mb-3">
          Current creators <span className="text-stone-300 font-normal">({creators.length})</span>
        </h2>
        {creators.length === 0 ? (
